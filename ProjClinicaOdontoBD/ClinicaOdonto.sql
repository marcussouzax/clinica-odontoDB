...
UPDATE FUNCIONARIO SET salario = 3000 WHERE id_funcionario = 4;

UPDATE SALA SET status = 'Em Uso' WHERE id_sala = 5;

UPDATE TRATAMENTO SET valor_base = 950 WHERE id_tratamento = 6;

UPDATE CONSULTA SET status = 'Finalizada' WHERE id_consulta = 7;

UPDATE AGENDAMENTO SET status = 'Cancelado' WHERE id_agendamento = 8;

UPDATE PAGAMENTO SET forma_pagamento = 'Pix' WHERE id_pagamento = 9;

UPDATE PRONTUARIO SET observacoes = 'Paciente em observação' WHERE id_prontuario = 10;
