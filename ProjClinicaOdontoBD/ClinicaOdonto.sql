...
/*
NESSE COMANDO ABAIXO UTILIZAMOS O JOIN 
PARA RELACIONAR AS TABELAS PACIENTE, CONSULTA E PAGAMENTO,
MOSTRANDO O NOME DO PACIENTE E OS DADOS DOS PAGAMENTOS
REALIZADOS VIA CONVÊNIO.
...
WHERE pg.forma_pagamento = 'Convenio'; */
